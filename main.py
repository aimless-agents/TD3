...
if __name__ == "__main__":
    ...
    parser.add_argument("--beta_step", default=0.048, type=float)   # Step size for beta annealing
    ...
    if args.prioritized_replay:
        replay_buffer = utils.PrioritizedReplayBuffer(state_dim, action_dim, args.max_timesteps, args.start_timesteps)
    else:
