...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_timesteps", default=2.5e5, type=int)   # Max time steps to run environment
    ...
    parser.add_argument("--tune", default=True)		# Whether or not tuning hyperparameters
    ...
    config = {
        "beta_step": tune.uniform(1e-3, 1e-1),
        "discount": tune.uniform(0.95, 1.0),
        "tau": tune.loguniform(1e-5, 1e-1),
    }
